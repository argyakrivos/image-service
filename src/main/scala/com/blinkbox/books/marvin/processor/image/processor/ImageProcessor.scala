package com.blinkbox.books.marvin.processor.image.processor
...
import com.blinkbox.books.marvin.processor.image.processor.ManagedResources._
...
import com.blinkbox.books.marvin.processor.image.processor.Gravity._
...
class ThreadPoolImageProcessor(threadCount: Int) extends ImageProcessor with StrictLogging with TimeLogging {
  import com.blinkbox.books.marvin.processor.image.processor.ThreadPoolImageProcessor._
